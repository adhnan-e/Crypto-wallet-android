...
public class WebviewActivity6 extends Fragment {
    ...
    private static final String TAG = WebviewActivity6.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_webview6, container, false);

        // Get reference of WebView from layout/activity_main.xml
        mWebView = (WebView) rootView.findViewById(R.id.webview6);
        ...
        if (mWebView.getUrl() == null) {
            mWebView.loadUrl("https://buy.moonpay.com");
    ...
    public void setThirdPartyCookiesEnabled(final boolean enabled) {
        if (Build.VERSION.SDK_INT >= 21) {
            CookieManager.getInstance().setAcceptThirdPartyCookies(mWebView, enabled);
        }
    }
    /**
