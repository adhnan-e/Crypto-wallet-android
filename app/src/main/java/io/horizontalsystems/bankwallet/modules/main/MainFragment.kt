    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        view.bottomNavigation.setOnNavigationItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.navigation_buycoin  -> view.viewPager.setCurrentItem(2, false)
                R.id.navigation_exchange  -> view.viewPager.setCurrentItem(3, false)
                R.id.navigation_settings -> view.viewPager.setCurrentItem(4, false)
            }
            true
        }
