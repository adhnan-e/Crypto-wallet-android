...
class AppConfigProvider : IAppConfigProvider, ILanguageConfigProvider, IAppConfigTestMode {
    ...
    override val companyWebPageLink: String = "https://cornerit.io"
    override val appWebPageLink: String = "https://cornerit.io"
    override val appGithubLink: String = "https://github.com/cornerit"
    ...
    override val reportEmail = "support@cornerit.io"
    override val walletHelpTelegramGroup = "corneritio"
    ...
    override val defaultCoins: List<Coin> by lazy {
        listOf(
                Coin("CNR",        "Corner",            "CNR",     8, CoinType.Erc20("0x722d30c2c5fFF3d5F33413578B77913aF1000946")),
